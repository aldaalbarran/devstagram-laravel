...
@section('content')
    <div class="md:flex md:justify-center md:gap-4 md:items-center">
        <div class="md:w-1/2 p-5">
            <img src="{{ asset('img/register.svg') }}" alt="Register" class="w-full">
        </div>
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form action="{{ route('register') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="name" name="name" placeholder="Introducir nombre" class="border p-3 w-full rounded-lg @error('name') border-red-500 @enderror" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="username" name="username" placeholder="Introducir nombre de usuario" class="border p-3 w-full rounded-lg @error('username') border-red-500 @enderror" value="{{ old('username') }}">
                    @error('username')
                        <p class="text-red-500 text-sm p-2">{{ $message }}</p>
                    @enderror
                </div>
