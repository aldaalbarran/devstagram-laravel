    ...
    <body class="bg-gray-100">
        <header class="p-5 border-b bg-white shadow">
            <div class="container mx-auto flex justify-between items-center">
                <a href="  {{ route('home') }} " class="text-2xl font-black">devstagram</a>
                ...
                @auth
                    <nav class="flex gap-2 items-center">
                        ...
                        <a class="font-bold text-gray-500" href="{{ route('posts.index', auth()->user()->username) }}">{{ auth()->user()->username }}</a>
        ...
        <main class="container mx-auto mt-10">
            <h2 class="font-black text-center text-2xl mb-10 text-gray-700">@yield('title')</h2>
            @yield('content')
        </main>
